...
struct RecordingCellViewModel: Hashable {
    let id: String
    let title: String
    let time: String
    let date: String
...
class RecordingCell: UICollectionViewCell {
    static let reusableId = "RecordingCell"
    ...
    func configure(_ viewModel: RecordingCellViewModel, _ isFirst: Bool = false, _ isLast: Bool = false) {
...
extension RecordingCell{
    static func recordingLayout() -> NSCollectionLayoutSection {
